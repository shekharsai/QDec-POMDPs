...
(:action observe-table
	...
	:precondition (and (in ?a ?i) (can-observe ?a ?t)(available ?a))
	:observe (inroom ?t ?i) )
...
(:action joint-lift-table	
	...
	:precondition (and 
			...
			(inroom ?t ?r1))
	:effect	(and 	(lifting ?a1 ?t ?r1)(not (available ?a1))
			(lifting ?a2 ?t ?r1)(not (available ?a2))
			(not (inroom ?t ?r1))) )
			
(:action joint-move-table
	:parameters (?a1 - agent ?a2 - agent ?t - table ?r1 - room ?r2 - room)
	:precondition (and 	
			(lifting ?a1 ?t ?r1) (lifting ?a2 ?t ?r1)
			(in ?a1 ?r1) (in ?a2 ?r1)
			(not (same-agent ?a1 ?a2))
			(connected ?r1 ?r2))
	:effect (and 
		...
		(not (lifting ?a1 ?t ?r1)) (not (lifting ?a2 ?t ?r1))
		(lifting ?a1 ?t ?r2) (lifting ?a2 ?t ?r2)))
...
(:action joint-drop-table
	...
	:precondition (and
			...
			(lifting ?a1 ?t ?r1) (lifting ?a2 ?t ?r1)
			(not (same-agent ?a1 ?a2)))
	:effect (and (inroom ?t ?r1)(available ?a1)
			(available ?a2) 
			(not (lifting ?a1 ?t ?r1)) (not (lifting ?a2 ?t ?r1))))
)
