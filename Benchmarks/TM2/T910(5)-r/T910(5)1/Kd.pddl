...
(:constants
 ...
 room6 - room
 room7 - room
 tag0 - TAG_TYPE ; (inroom table4 room7) (inroom table1 room4) (inroom table3 room6) (inroom table2 room1)
 tag1 - TAG_TYPE ; (inroom table4 room6) (not (inroom table1 room4)) (not (inroom table3 room6)) (not (inroom table2 room1))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
