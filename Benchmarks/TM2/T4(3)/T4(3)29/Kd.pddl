...
(:constants
 ...
 room4 - room
 dd - dummy
 tag0 - TAG_TYPE ; (inroom table1 room4) (inroom table3 room2)
 tag1 - TAG_TYPE ; (not (inroom table1 room4)) (not (inroom table3 room2))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:parameters ( ?a1 - agent ?a2 - agent ?t - table ?r1 - room ?dd - dummy)
:precondition 
(and (= ?a1 a1) (= ?a2 a3) (= ?t table1) (= ?r1 room4) (c-p-joint-drop-table-5aw ?dd) 
	(or (not (= ?a1 a1)) (not (= ?a2 a2)) (not (= ?t table2)) (not (= ?r1 room1)))
	(or (not (= ?a1 a3)) (not (= ?a2 a1)) (not (= ?t table3)) (not (= ?r1 room2)))
	(or (not (= ?a1 a3)) (not (= ?a2 a1)) (not (= ?t table2)) (not (= ?r1 room1)))
	(or (not (= ?a1 a1)) (not (= ?a2 a3)) (not (= ?t table3)) (not (= ?r1 room2)))
