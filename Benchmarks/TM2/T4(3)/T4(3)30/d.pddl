...
(:action observe-table-hit-u0y-xsp-cpw-us5-29d-bsj-1p2-3wn-pr4-8g4
	:parameters ( ?a - agent ?t - table ?i - room )
	:precondition (and 
		(= ?a a3)(= ?t table3)(= ?i room1)(observe-joint-drop-table-ausj-iut dd)
		(= ?a a3)
		(= ?t table3)
		(= ?i room1)
...
(and (inroom ?t ?r1) (available ?a1) (available ?a2) (not (lifting ?a1 ?t ?r1)) (not (lifting ?a2 ?t ?r1))) )
)
...
(and 
	(when (c-p-joint-drop-table-6qd ?dd) (not (c-p-joint-drop-table-6qd ?dd)))(inroom ?t ?r1) (available ?a1) (available ?a2) (not (lifting ?a1 ?t ?r1)) (not (lifting ?a2 ?t ?r1))) )
)
...
(:action joint-drop-table-ausj
	:parameters ( ?a1 - agent ?a2 - agent ?t - table ?r1 - room ?dd - dummy )
	:precondition (and 
		(or (not (= ?a1 a1))(not (= ?a2 a3))(not (= ?t table1))(not (= ?r1 room4))(not (= ?dd dd)))
		(= ?a1 a1)
		(= ?a2 a3)
		(= ?t table1)
		(= ?r1 room4)
...
(:action joint-drop-table-ausj-26xs
	:parameters ( ?a1 - agent ?a2 - agent ?t - table ?r1 - room ?dd - dummy )
	:precondition (and 
		(= ?a1 a1)(= ?a2 a3)(= ?t table1)(= ?r1 room4)(= ?dd dd)(c-p-joint-drop-table-ausj-iut ?dd)
		(= ?a1 a1)
		(= ?a2 a3)
		(= ?t table1)
		(= ?r1 room4)
	...
	:effect (and (when (c-p-joint-drop-table-ausj-iut ?dd) (not (c-p-joint-drop-table-ausj-iut ?dd)) )
		(when (c-p-joint-drop-table-5aw ?dd) (not (c-p-joint-drop-table-5aw ?dd)))
		(inroom ?t ?r1)
		(available ?a1)
		(available ?a2)
...
(:action commit-3tfyt-a1-a2-a3
	:parameters (?a - agent)
	:precondition (and (not (observe-joint-drop-table-ausj-iut dd)) )
	:effect (and (c-p-joint-drop-table-ausj-iut dd))
)
(:action obs-5gczo-a1-a2-a3
	:parameters (?a - agent)
	:precondition (and (not (observe-joint-drop-table-ausj-iut dd)))
	:effect (and (observe-joint-drop-table-ausj-iut dd))
)
