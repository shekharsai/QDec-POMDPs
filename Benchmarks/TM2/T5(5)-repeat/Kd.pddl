...
(:constants
 ...
 room3 - room
 room4 - room
 tag0 - TAG_TYPE ; (inroom table1 room3) (not (inroom table1 room4)) (inroom table2 room2) (not (inroom table2 room1)) (inroom table3 room2) (not (inroom table3 room3)) (inroom table4 room1) (not (inroom table4 room2)) (inroom table5 room4) (not (inroom table5 room3))
 tag1 - TAG_TYPE ; (not (inroom table1 room3)) (inroom table1 room4) (not (inroom table2 room2)) (inroom table2 room1) (not (inroom table3 room2)) (inroom table3 room3) (not (inroom table4 room1)) (inroom table4 room2) (not (inroom table5 room4)) (inroom table5 room3)
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:precondition 
(and (in ?a ?i) (can-observe ?a ?t) (available ?a) (inroom ?t ?i) (not (Kinroom ?t ?i ?a V_TRUE)) (not (Kinroom ?t ?i ?a V_FALSE)))
:effect 
...
:parameters ( ?a - agent ?t - table ?i - room)
:precondition 
(and (in ?a ?i) (can-observe ?a ?t) (available ?a) (not (inroom ?t ?i)) (not (Kinroom ?t ?i ?a V_TRUE)) (not (Kinroom ?t ?i ?a V_FALSE)))
:effect 
