...
(:constants
 ...
 room6 - room
 room7 - room
 tag0 - TAG_TYPE ; (inroom table3 room6) (inroom table4 room7) (inroom table2 room2) (inroom table1 room3)
 tag1 - TAG_TYPE ; (inroom table3 room5) (inroom table4 room6) (not (inroom table2 room2)) (not (inroom table1 room3))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
