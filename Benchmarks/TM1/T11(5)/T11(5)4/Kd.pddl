...
(:constants
 ...
 room7 - room
 dd - dummy
 tag0 - TAG_TYPE ; (inroom table3 room5) (inroom table1 room3) (inroom table4 room7) (inroom table2 room1)
 tag1 - TAG_TYPE ; (not (inroom table3 room5)) (not (inroom table1 room3)) (not (inroom table4 room7)) (not (inroom table2 room1))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
