...
(:constants
 ...
 room7 - room
 dd - dummy
 tag0 - TAG_TYPE ; (inroom table3 room5) (inroom table4 room7) (inroom table1 room3) (inroom table2 room1)
 tag1 - TAG_TYPE ; (not (inroom table3 room5)) (not (inroom table4 room7)) (not (inroom table1 room3)) (not (inroom table2 room1))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
(Kc-p-joint-drop-table-cvs ?dd - dummy ?AGENT_PARAM - AGENT ?V_PARAM - VALUE_TYPE)
(KGivenc-p-joint-drop-table-cvs ?dd - dummy ?TAG_PARAM - TAG_TYPE ?AGENT_PARAM - AGENT ?V_PARAM - VALUE_TYPE)
(observe-joint-drop-table-cvs ?dd - dummy)
(Kobserve-joint-drop-table-cvs ?dd - dummy ?AGENT_PARAM - AGENT ?V_PARAM - VALUE_TYPE)
(KGivenobserve-joint-drop-table-cvs ?dd - dummy ?TAG_PARAM - TAG_TYPE ?AGENT_PARAM - AGENT ?V_PARAM - VALUE_TYPE)
(c-p-joint-drop-table-teq ?dd - dummy)
(Kc-p-joint-drop-table-teq ?dd - dummy ?AGENT_PARAM - AGENT ?V_PARAM - VALUE_TYPE)
(KGivenc-p-joint-drop-table-teq ?dd - dummy ?TAG_PARAM - TAG_TYPE ?AGENT_PARAM - AGENT ?V_PARAM - VALUE_TYPE)
(observe-joint-drop-table-teq ?dd - dummy)
(Kobserve-joint-drop-table-teq ?dd - dummy ?AGENT_PARAM - AGENT ?V_PARAM - VALUE_TYPE)
(KGivenobserve-joint-drop-table-teq ?dd - dummy ?TAG_PARAM - TAG_TYPE ?AGENT_PARAM - AGENT ?V_PARAM - VALUE_TYPE)
(KNot ?TAG_PARAM - TAG_TYPE ?AGENT_PARAM - AGENT)
(Observed ?AGENT_PARAM - AGENT)
)

(:action observe-table-twk-T
:parameters ( ?a - agent ?t - table ?i - room)
:precondition 
(and (= ?a a3) (= ?t table1) (= ?i room3) (observe-joint-drop-table-cvs dd) (in ?a ?i) (can-observe ?a ?t) (inroom ?t ?i) (not (Kinroom ?t ?i ?a V_TRUE)) (not (Kinroom ?t ?i ?a V_FALSE)))
:effect 
(and (Kinroom ?t ?i ?a V_TRUE) (Observed ?a))
)
(:action observe-table-twk-F
:parameters ( ?a - agent ?t - table ?i - room)
:precondition 
(and (= ?a a3) (= ?t table1) (= ?i room3) (observe-joint-drop-table-cvs dd) (in ?a ?i) (can-observe ?a ?t) (not (inroom ?t ?i)) (not (Kinroom ?t ?i ?a V_TRUE)) (not (Kinroom ?t ?i ?a V_FALSE)))
:effect 
(and (Kinroom ?t ?i ?a V_FALSE) (Observed ?a))
)
(:action observe-table-lsq-T
:parameters ( ?a - agent ?t - table ?i - room)
:precondition 
(and (= ?a a4) (= ?t table1) (= ?i room3) (observe-joint-drop-table-teq dd) 
...
:precondition 
(and (= ?a1 a2) (= ?a2 a1) (= ?t table2) (= ?r1 room1) (c-p-joint-drop-table-teq ?dd) 
	(or (not (= ?a1 a1)) (not (= ?a2 a2)) (not (= ?t table2)) (not (= ?r1 room1)))(in ?a1 ?r1) (in ?a2 ?r1) (lifting ?a1 ?t) (lifting ?a2 ?t) (not (same-agent ?a1 ?a2)))
:effect (and 
	(not (lifting ?a1 ?t)) 
	(not (lifting ?a2 ?t)) 
	...
	(forall (?a2 - agent) (Kinroom ?t ?r1 ?a2 V_TRUE))
	(forall (?a2 - agent) (not (Kinroom ?t ?r1 ?a2 V_FALSE)))
	(when (c-p-joint-drop-table-teq ?dd) (not (c-p-joint-drop-table-teq ?dd))) 
	(when (c-p-joint-drop-table-teq ?dd) 	(and (Kc-p-joint-drop-table-teq ?dd ?a1 V_FALSE) (not (Kc-p-joint-drop-table-teq ?dd ?a1 V_TRUE)))) 
	(when (c-p-joint-drop-table-teq ?dd) 	(and (Kc-p-joint-drop-table-teq ?dd ?a2 V_FALSE) (not (Kc-p-joint-drop-table-teq ?dd ?a2 V_TRUE)))) 
)
)
(:action commit-rm6ay-a1-a2-a3-a4-a5
:parameters ( ?a - agent)
:precondition 
(and (not (observe-joint-drop-table-teq dd)))
:effect (and 
	(c-p-joint-drop-table-teq dd) 
)
)
...
(and (not (observe-joint-drop-table-teq dd)))
:effect (and 
	(observe-joint-drop-table-teq dd) 
)
)
(:action joint-drop-table-8j1k
:parameters ( ?a1 - agent ?a2 - agent ?t - table ?r1 - room ?dd - dummy)
:precondition 
(and (= ?a1 a1) (= ?a2 a2) (= ?t table2) (= ?r1 room1) (c-p-joint-drop-table-cvs ?dd) (in ?a1 ?r1) (in ?a2 ?r1) (lifting ?a1 ?t) (lifting ?a2 ?t) (not (same-agent ?a1 ?a2)))
:effect (and 
	(not (lifting ?a1 ?t)) 
	(not (lifting ?a2 ?t)) 
	(inroom ?t ?r1) 
	...
	(forall (?a2 - agent) (Kinroom ?t ?r1 ?a2 V_TRUE))
	(forall (?a2 - agent) (not (Kinroom ?t ?r1 ?a2 V_FALSE)))
	(when (c-p-joint-drop-table-cvs ?dd) (not (c-p-joint-drop-table-cvs ?dd))) 
	(when (c-p-joint-drop-table-cvs ?dd) 	(and (Kc-p-joint-drop-table-cvs ?dd ?a1 V_FALSE) (not (Kc-p-joint-drop-table-cvs ?dd ?a1 V_TRUE)))) 
	(when (c-p-joint-drop-table-cvs ?dd) 	(and (Kc-p-joint-drop-table-cvs ?dd ?a2 V_FALSE) (not (Kc-p-joint-drop-table-cvs ?dd ?a2 V_TRUE)))) 
)
)
(:action commit-ihwcx-a1-a2-a3-a4-a5
:parameters ( ?a - agent)
:precondition 
(and (not (observe-joint-drop-table-cvs dd)))
:effect (and 
