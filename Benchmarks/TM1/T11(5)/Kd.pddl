...
(:constants
 ...
 room6 - room
 room7 - room
 tag0 - TAG_TYPE ; (inroom table2 room2) (inroom table1 room4) (inroom table4 room7) (inroom table3 room6)
 tag1 - TAG_TYPE ; (not (inroom table2 room2)) (not (inroom table1 room4)) (not (inroom table4 room7)) (not (inroom table3 room6))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
