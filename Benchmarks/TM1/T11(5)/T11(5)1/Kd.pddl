...
(:constants
 ...
 room6 - room
 room7 - room
 tag0 - TAG_TYPE ; (not (inroom table3 room5)) (inroom table3 room6) (not (inroom table4 room6)) (inroom table4 room7) (not (inroom table2 room1)) (inroom table2 room2) (not (inroom table1 room3)) (inroom table1 room4)
 tag1 - TAG_TYPE ; (inroom table3 room5) (not (inroom table3 room6)) (inroom table4 room6) (not (inroom table4 room7)) (inroom table2 room1) (not (inroom table2 room2)) (inroom table1 room3) (not (inroom table1 room4))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:precondition 
(and (in ?a ?i) (can-observe ?a ?t) (inroom ?t ?i) (not (Kinroom ?t ?i ?a V_TRUE)) (not (Kinroom ?t ?i ?a V_FALSE)))
:effect 
...
:parameters ( ?a - agent ?t - table ?i - room)
:precondition 
(and (in ?a ?i) (can-observe ?a ?t) (not (inroom ?t ?i)) (not (Kinroom ?t ?i ?a V_TRUE)) (not (Kinroom ?t ?i ?a V_FALSE)))
:effect 
