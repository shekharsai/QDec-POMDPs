...
(:constants
 ...
 room6 - room
 room7 - room
 tag0 - TAG_TYPE ; (inroom table4 room6) (inroom table1 room4) (inroom table2 room1) (inroom table3 room4)
 tag1 - TAG_TYPE ; (not (inroom table4 room6)) (not (inroom table1 room4)) (not (inroom table2 room1)) (not (inroom table3 room4))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
