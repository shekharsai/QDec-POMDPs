...
(:constants
 ...
 room3 - room
 room4 - room
 tag0 - TAG_TYPE ; (inroom table1 room4) (inroom table2 room2) (inroom table3 room2) (inroom table4 room1)
 tag1 - TAG_TYPE ; (not (inroom table1 room4)) (not (inroom table2 room2)) (not (inroom table3 room2)) (not (inroom table4 room1))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
