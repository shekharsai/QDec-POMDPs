...
(:constants
 ...
 room6 - room
 room7 - room
 tag0 - TAG_TYPE ; (inroom table1 room4) (inroom table2 room1) (inroom table3 room4) (inroom table4 room7)
 tag1 - TAG_TYPE ; (not (inroom table1 room4)) (not (inroom table2 room1)) (not (inroom table3 room4)) (not (inroom table4 room7))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
