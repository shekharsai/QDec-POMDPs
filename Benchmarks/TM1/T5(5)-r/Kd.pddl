...
(:constants
 ...
 room3 - room
 room4 - room
 tag0 - TAG_TYPE ; (not (inroom table2 room2)) (inroom table2 room1) (not (inroom table1 room3)) (inroom table1 room4) (not (inroom table4 room1)) (inroom table4 room2) (not (inroom table3 room3)) (inroom table3 room2) (not (inroom table5 room3)) (inroom table5 room4)
 tag1 - TAG_TYPE ; (inroom table2 room2) (not (inroom table2 room1)) (inroom table1 room3) (not (inroom table1 room4)) (inroom table4 room1) (not (inroom table4 room2)) (inroom table3 room3) (not (inroom table3 room2)) (inroom table5 room3) (not (inroom table5 room4))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:precondition 
(and (in ?a ?i) (inroom ?t ?i) (not (Kinroom ?t ?i ?a V_TRUE)) (not (Kinroom ?t ?i ?a V_FALSE)))
:effect 
...
:parameters ( ?a - agent ?t - table ?i - room)
:precondition 
(and (in ?a ?i) (not (inroom ?t ?i)) (not (Kinroom ?t ?i ?a V_TRUE)) (not (Kinroom ?t ?i ?a V_FALSE)))
:effect 
...
:parameters ( ?a1 - agent ?a2 - agent ?t - table ?r1 - room)
:precondition 
(and (in ?a1 ?r1) (in ?a2 ?r1) (lifting ?a1 ?t) (lifting ?a2 ?t) (not (same-agent ?a1 ?a2)))
:effect (and 
	(not (lifting ?a1 ?t)) 
	(not (lifting ?a2 ?t)) 
	(inroom ?t ?r1) 
