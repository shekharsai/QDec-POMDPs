...
(:constants
 ...
 a4 - agent
 a5 - agent
 tag0 - TAG_TYPE ; (box-at b5 p5-1) (box-at b1 p2-2) (box-at b2 p3-1) (box-at b4 p4-2) (box-at b0 p1-2)
 tag1 - TAG_TYPE ; (box-at b5 p5-2) (not (box-at b1 p2-2)) (not (box-at b2 p3-1)) (not (box-at b4 p4-2)) (not (box-at b0 p1-2))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
