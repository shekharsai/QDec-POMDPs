...
(:constants
 ...
 a3 - agent
 a4 - agent
 tag0 - TAG_TYPE ; (box-at b4 p4-2) (box-at b0 p1-1) (box-at b1 p2-2) (box-at b2 p3-2)
 tag1 - TAG_TYPE ; (not (box-at b4 p4-2)) (not (box-at b0 p1-1)) (not (box-at b1 p2-2)) (not (box-at b2 p3-2))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
