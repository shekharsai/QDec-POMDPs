...
:precondition 
(and (at ?agent0 ?p) (at ?agent1 ?p) (at_rock_sample ?p) (equipped_for_rock_analysis ?agent0) (equipped_for_rock_analysis ?agent1) (store_of ?s ?agent0) (empty ?s))
:effect 
(and (not (empty ?s)) (full ?s) (have_rock_analysis ?agent0) (not (at_rock_sample ?p)))
)
