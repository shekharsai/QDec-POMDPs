...
(:types agent waypoint store camera mode lander objective TAG_TYPE VALUE_TYPE)
(:constants
 agent0 - agent
 agent1 - agent
 agent2 - agent
 ...
 tag0 - TAG_TYPE ; (visible-from objective3 waypoint3) (visible-from objective1 waypoint5) (visible-from objective2 waypoint1)
 tag1 - TAG_TYPE ; (visible-from objective3 waypoint0) (not (visible-from objective1 waypoint5)) (not (visible-from objective2 waypoint1))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:precondition 
(and (at ?x ?z) (at-rock-sample ?z) (not (Kat-rock-sample ?z ?x V_TRUE)) (not (Kat-rock-sample ?z ?x V_FALSE)))
:effect 
...
:parameters ( ?x - agent ?z - waypoint)
:precondition 
(and (at ?x ?z) (not (at-rock-sample ?z)) (not (Kat-rock-sample ?z ?x V_TRUE)) (not (Kat-rock-sample ?z ?x V_FALSE)))
:effect 
...
:parameters ( ?x - agent ?z - waypoint)
:precondition 
(and (at ?x ?z) (at-soil-sample ?z) (not (Kat-soil-sample ?z ?x V_TRUE)) (not (Kat-soil-sample ?z ?x V_FALSE)))
:effect 
...
:parameters ( ?x - agent ?z - waypoint)
:precondition 
(and (at ?x ?z) (not (at-soil-sample ?z)) (not (Kat-soil-sample ?z ?x V_TRUE)) (not (Kat-soil-sample ?z ?x V_FALSE)))
:effect 
