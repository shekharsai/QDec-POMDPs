...
(:init
	...
	(dummy-right-kq5_observe-soil_agent0_waypoint5 dd)
	(at agent2 waypoint4)
	(dummy-left-eaw_observe-rock_agent2_waypoint4 dd)
	(immediate-dummy-5vp_observe-vis_agent0_objective1_waypoint4 dd)
)
(:goal (done-goal dd))
)
