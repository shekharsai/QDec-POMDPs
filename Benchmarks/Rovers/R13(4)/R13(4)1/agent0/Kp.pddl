...
(:init
	...
	(dummy-left-ghv_observe-soil_agent0_waypoint5 dd)
	(dummy-right-8t9_observe-rock_agent2_waypoint4 dd)
	(dummy-left-tg6_observe-vis_agent3_objective1_waypoint4 dd)
	(at agent0 waypoint5)
	(immediate-dummy-g97_observe-vis_agent0_objective1_waypoint5 dd)
)
(:goal (done-goal dd))
)
