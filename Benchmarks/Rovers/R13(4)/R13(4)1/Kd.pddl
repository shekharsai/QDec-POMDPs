...
(:constants
 ...
 dd - dummy
 tag0 - TAG_TYPE ; (visible-from objective1 waypoint0) (not (visible-from objective1 waypoint5)) (not (at-soil-sample waypoint5)) (at-soil-sample waypoint4) (not (at-rock-sample waypoint4)) (at-rock-sample waypoint5) (not (visible-from objective1 waypoint4))
 tag1 - TAG_TYPE ; (not (visible-from objective1 waypoint0)) (visible-from objective1 waypoint5) (at-soil-sample waypoint5) (not (at-soil-sample waypoint4)) (at-rock-sample waypoint4) (not (at-rock-sample waypoint5)) (visible-from objective1 waypoint4)
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
