...
(:constants
 ...
 dd - dummy
 tag0 - TAG_TYPE ; (at-rock-sample waypoint5) (at-soil-sample waypoint5) (visible-from objective1 waypoint0)
 tag1 - TAG_TYPE ; (not (at-rock-sample waypoint5)) (not (at-soil-sample waypoint5)) (not (visible-from objective1 waypoint0))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
