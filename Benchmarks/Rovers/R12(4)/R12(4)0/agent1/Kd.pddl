...
(:constants
 ...
 dd - dummy
 dd - dummy
 tag0 - TAG_TYPE ; (at-soil-sample waypoint4)
 tag1 - TAG_TYPE ; (at-soil-sample waypoint5)
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
(:action act-hsx_observe-rock_agent1_waypoint4-T
:parameters ( ?a - agent)
:precondition 
(and (init-hsx_observe-rock_agent1_waypoint4 dd) (immediate-dummy-hsx_observe-rock_agent1_waypoint4 dd) (at agent1 waypoint4) (at-rock-sample waypoint4) (not (Kat-rock-sample waypoint4 V_TRUE)) (not (Kat-rock-sample waypoint4 V_FALSE)))
:effect 
(and (Kat-rock-sample waypoint4 V_TRUE))
)
(:action act-hsx_observe-rock_agent1_waypoint4-F
:parameters ( ?a - agent)
:precondition 
(and (init-hsx_observe-rock_agent1_waypoint4 dd) (immediate-dummy-hsx_observe-rock_agent1_waypoint4 dd) (at agent1 waypoint4) (not (at-rock-sample waypoint4)) (not (Kat-rock-sample waypoint4 V_TRUE)) (not (Kat-rock-sample waypoint4 V_FALSE)))
:effect 
...
:parameters ( ?a - agent)
:precondition 
(and (init-hsx_observe-rock_agent1_waypoint4 dd) (not (dummy-left-hsx_observe-rock_agent1_waypoint4 dd)) (not (dummy-right-hsx_observe-rock_agent1_waypoint4 dd)))
:effect 
(and (immediate-dummy-hsx_observe-rock_agent1_waypoint4 dd))
)
(:action dummy-left-hsx_observe-rock_agent1_waypoint4
:parameters ( ?a - agent)
:precondition 
(and (init-hsx_observe-rock_agent1_waypoint4 dd) (at agent1 waypoint4) (not (at-rock-sample waypoint4)) (immediate-dummy-hsx_observe-rock_agent1_waypoint4 dd) (Kat-rock-sample waypoint4 V_FALSE))
:effect 
(and (not (init-hsx_observe-rock_agent1_waypoint4 dd)) (not (immediate-dummy-hsx_observe-rock_agent1_waypoint4 dd)) (dummy-left-hsx_observe-rock_agent1_waypoint4 dd))
)
(:action dummy-right-hsx_observe-rock_agent1_waypoint4
:parameters ( ?a - agent)
:precondition 
(and (init-hsx_observe-rock_agent1_waypoint4 dd) (at agent1 waypoint4) (at-rock-sample waypoint4) (immediate-dummy-hsx_observe-rock_agent1_waypoint4 dd) (Kat-rock-sample waypoint4 V_TRUE))
:effect 
(and (not (init-hsx_observe-rock_agent1_waypoint4 dd)) (not (immediate-dummy-hsx_observe-rock_agent1_waypoint4 dd)) (dummy-right-hsx_observe-rock_agent1_waypoint4 dd))
)
(:action goal-achieve-left-hsx_observe-rock_agent1_waypoint4
:parameters ( ?a - agent)
:precondition 
(and (dummy-left-hsx_observe-rock_agent1_waypoint4 dd) (not (at-rock-sample waypoint4)) (Kat-rock-sample waypoint4 V_FALSE))
:effect 
(and (done-goal dd) (not (dummy-left-hsx_observe-rock_agent1_waypoint4 dd)))
)
(:action act-s2i_sample-rock_agent3_agent1_a1store_waypoint4
:parameters ( ?a - agent)
:precondition 
(and (dummy-right-hsx_observe-rock_agent1_waypoint4 dd) (at-rock-sample waypoint4) (at agent1 waypoint4) (Kat-rock-sample waypoint4 V_TRUE))
:effect 
(and (pre-s2i_sample-rock_agent3_agent1_a1store_waypoint4 dd))
)
...
(and (pre-s2i_sample-rock_agent3_agent1_a1store_waypoint4 dd))
:effect 
(and (done-goal dd) (not (pre-s2i_sample-rock_agent3_agent1_a1store_waypoint4 dd)))
)
