...
(:init
	...
	(dummy-left-vol_observe-vis_agent2_objective1_waypoint4 dd)
	(dummy-right-3me_observe-rock_agent2_waypoint4 dd)
	(dummy-right-aqp_observe-soil_agent2_waypoint4 dd)
	(dummy-left-dt3_observe-vis_agent1_objective2_waypoint2 dd)
	(at agent1 waypoint5)
	(dummy-left-gg8_observe-vis_agent2_objective2_waypoint5 dd)
	(immediate-dummy-ug2_observe-vis_agent0_objective1_waypoint5 dd)
)
(:goal (done-goal dd))
)
