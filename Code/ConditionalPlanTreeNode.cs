...
namespace CPOR_MA
{
    public class ConditionalPlanTreeNode
    {
        ...
        public ConditionalPlanTreeNode SingleParent { get; set; }
        
        // Required - as the parser cannot handle an observation action with effect
        public Action DummyParentActionForObs { get; set; }

        public Action DummyChildActionForFalseObs { get; set; }
        public Action DummyChildActionForTrueObs  { get; set; }
