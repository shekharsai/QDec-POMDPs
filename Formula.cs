...
namespace CPOR_MA
{
    public abstract class Formula
    {
        ...
        public abstract void GetAllOperands(List<Formula> lFormula);
        ...
        public List<Formula> GetAllOperands()
        {
            List<Formula> lFormula = new List<Formula>();
            GetAllOperands(lFormula);
            return lFormula;
        }
        ...
        public abstract Formula GenerateGiven(string sTag, List<string> lAlwaysKnown, Argument cAgent);
        ...
        public abstract Formula GetKnowledgeFormula(List<string> lAlwaysKnown, Argument aAgent);
